	...
	<div id="main">
		<div id="book">
			...
			<div style="text-align: center">
				您的购物车中共有<span id="cartTotalCount" style="color: red">${sessionScope.cart.totalCount}</span>本书
				<div>
					您刚刚将<span id="lastName" style="color: red">${requestScope.lastName}</span>加入到了购物车中
				</div>
			</div>
